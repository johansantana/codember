...
Now, to prove that we are capable of creating an algorithm that works, we have the list of patrons of the midudev community: [https://codember.dev/mecenas.json](https://codember.dev/mecenas.json)
